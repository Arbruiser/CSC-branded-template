...
This puts the live link right at the top of the repo so you never have to remember the URL!
5. If you see a green tick appear next to your name in the repository, the website has been deployed correctly. To force refresh the website page (to tell your browser not to use the cached version), press ctrl + F5 on Linux and Windows, or Cmd + Shift + R on Mac. 

[^1]: [It can take up to 10 minutes for changes to your site to publish after you push the changes to GitHub](https://docs.github.com/en/pages/setting-up-a-github-pages-site-with-jekyll/creating-a-github-pages-site-with-jekyll#creating-your-site).

Every time you push a commit to github, the website will be redeployed and you can see your changes.
