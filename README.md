...
5. If you see a green tick appear next to your name in the repository, the website has been deployed correctly. To force refresh the website page (to tell your browser not to use the cached version), click ctrl+F5 on Linux. 
